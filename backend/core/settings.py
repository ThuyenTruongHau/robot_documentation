...
ALLOWED_HOSTS = config(
    'ALLOWED_HOSTS', 
    default='localhost,127.0.0.1,robot-documentation-2003.onrender.com,rfid.thadorobot.com,www.rfid.thadorobot.com', 
...
DATABASES = {
    'default': {
        ...
        'NAME': config('DB_NAME', default='thado_robot'),
...
REST_FRAMEWORK = {
    ...
    'DEFAULT_PERMISSION_CLASSES': (
        'rest_framework.permissions.AllowAny',  #Thêm để test, sau đổi lại IsAuthenticated
    ),
...
DEFAULT_FROM_EMAIL = config('DEFAULT_FROM_EMAIL', default='noreply@thadorobot.com')
CONTACT_EMAIL = config('CONTACT_EMAIL', default='hau23062003@gmail.com')  # Email nhận liên hệ
